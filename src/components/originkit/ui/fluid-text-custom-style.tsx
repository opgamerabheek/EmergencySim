...
function __OriginkitBase_FluidText(props: Props) {
  const {
    text = DEFAULTS.text,
...
export default function FluidText(props: Record<string, unknown>) {
  return <__OriginkitBase_FluidText {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
