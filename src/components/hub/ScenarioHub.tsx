  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#050608] text-white font-quicksand relative overflow-hidden">
      ...
      <div className="relative" style={{ zIndex: 10 }}>
        ...
        <main className="flex-1 max-w-[90rem] mx-auto w-full px-6 md:px-12 py-10 md:py-14 flex flex-col justify-between">
        {/* Top Navigation: Green-tinted Glass Home Button */}
        <div className="mb-8 flex items-center justify-start">
          <button
            onClick={() => navigate('/')}
            style={{ backgroundColor: 'rgba(42, 53, 24, 0.48)' }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#A9C46C]/35 backdrop-blur-md text-xs sm:text-sm font-medium text-[#D4E7A3] shadow-lg shadow-[#3F4826]/15 hover:scale-105 active:scale-95 transition-transform duration-200 cursor-pointer"
        ...
        <div className="mb-12 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full liquid-glass border border-[#A9C46C]/20 text-xs font-mono-data text-[#D4E7A3]/80">
            <Sparkles className="w-3.5 h-3.5 text-[#A9C46C]" />
          ...
          <p className="text-base md:text-lg text-white/60 max-w-3xl font-light">
        ...
        <div className="liquid-glass rounded-2xl p-8 md:p-10 border border-[#A9C46C]/15 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-[#18210F]/80 border border-[#A9C46C]/20 text-[#D4E7A3]/90">
              <ShieldAlert className="w-8 h-8" />
            </div>
            <div>
              <h4 className="font-display font-medium text-lg text-[#D4E7A3]">
          ...
          <div className="text-xs font-mono-data text-[#A9C46C]/70 px-4 py-2 rounded-lg bg-[#18210F]/70 border border-[#A9C46C]/15">
